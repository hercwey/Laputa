...
public class ZookeeperUtil implements Watcher {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            node.setPath(path);
            node.setData("10.20.219.126:1234");
            util.createConnection("192.168.226.131:2181", 1000);
            util.createPath(node.getPath(), node.getData());
        ...
        // regitser targets, localhost:1234
